...
?>
  ...
  <div id="canr">
    ...
    <table id='tbl2' class="container-fluid col-lg-10 mr-lg-2 table  table-hover table-bordered table-striped">
      <thead>
        <th>Ride id</th>
        <th onclick="sortTable(1,tbl2)">Thời gian đặt &#9660;</th>
        <th>Điểm xuất phát</th>
        <th>Điểm đến</th>
        <th>Loại xe</th>
        <th onclick="sortTablen(5,tbl2)">Quãng đường &#9660;</th>
        <th>Hành lý</th>
        <th onclick="sortTablen(7,tbl2)">Tổng tiền &#9660;</th>
        <th>Trạng thái</th>
        <th>Mã TK</th>
        <th>Xóa</th>
      </thead>
      <tbody id="tbl2c">
        ...
        foreach ($can as $key => $val) {
          ...
          echo "<td><a class='btn btn-danger' onClick=\"javascript: return confirm('Vui lòng xác nhận xóa');\" href='acanride.php?action=no&id=" . $val['ride_id'] . "'>Xóa</a></td></tr></tr>";
        }
        ?>
      </tbody>
    </table>
