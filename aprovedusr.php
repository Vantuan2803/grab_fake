...
if ($_SESSION['userdata']['role'] == 1) {
  ...
  <nav class="nav nav-pills nav-justified col-sm-10">
    <a class="nav-link btn-light " href="allusers.php">Tất cả tài khoản</a>
    <a class="nav-link btn-light " href="aprove.php">Phê duyệt tài khoản</a>
    <a class="nav-link btn-light active" href="aprovedusr.php">Tài khoản đã phê duyệt</a>
  </nav>
      ...
      <tbody>
        ...
        foreach ($show as $key => $val) {
          echo "<tr>
                ...
                <td>" . $val['mobile'] . "</td>
                <td><a class='btn btn-warning' href='aprovedusr.php?action=no&id=" . $val['user_id'] . "'>Khóa</a></td>
                </tr>";
        }
        ?>
