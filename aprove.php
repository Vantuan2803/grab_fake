...
?>
  <nav class="nav nav-pills nav-justified col-sm-10">
    ...
    <a class="nav-link btn-light active" href="aprove.php">Phê duyệt tài khoản</a>
      ...
      <tbody>
        ...
        foreach ($show as $key => $val) {
          echo "<tr>
                  ...
                  <td>" . $val['mobile'] . "</td>
                  <td><a class='btn btn-success' href='aprove.php?action=yes&id=" . $val['user_id'] . "'>Chấp nhận</a></td>
                </tr>";
        }
        ?>
      </tbody>
