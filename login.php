      ...
      <div id="bg" class="banner pt-2 pb-2">
        ...
        <section class="container-fluid box col-lg-10 col-sm-10 col-xs-12 col-md-7  pt-lg-4 mt-lg-4 pt-sm-0 mt-sm-0 mb-5 pb-3 pt-2">
          <div class="text-center">
            <h4 class="font-weight-bold">Đăng nhập với tài khoản</h4>
          </div>
          <form action="login.php" method="post">
            <div class="form-group row feilds">
              <label class="col-sm-2" for="email">Email</label>
              <input name="email" type="email" class="form-control-plaintext col-sm-10 arro" id="email" placeholder="Nhập email của bạn" <?php
            ...
            <div class="form-group  row feilds ">
              ...
              <input type="password" name="password" class="form-control-plaintext col-sm-10 arro" id="password" placeholder="Nhập mật khẩu của bạn" required>
            </div>
            <div class="form-group ">
              <input type="submit" class="btn green btn-primary btn-lg btn-block" id="login" name="submit" value="Đăng nhập">
            </div>
          </form>
      </div>
      </section>
