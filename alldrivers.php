...
?>
    ...
    <nav class="nav nav-pills nav-justified col-sm-10">
        <a class="nav-link btn-light active" href="alldrivers.php">Tất cả tài khoản</a>
    ...
    <div class="center">
        ...
        <table id="tbl" class="container-fluid col-lg-10 mr-lg-2 table  table-hover table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <th onclick="sortTable(5,'tbl')">Loại xe</th>
                    <th>Hành động</th>
                </tr>
            </thead>
            <tbody>
        ...
        <td>" . $val['mobile'] . "</td>
        <td>" . getCabName($val['vehicle_type'], $admc) . "</td>";
                    echo "<td>";
                    if ($val['isblock'] == 1) {
                        echo "<a class='btn btn-warning' href='alldrivers.php?action=blk&id=" . $val['user_id'] . "'>Khóa</a>";
                    } elseif ($val['isblock'] == 0) {
                        echo "<a class='btn btn-success' href='alldrivers.php?action=app&id=" . $val['user_id'] . "'>Chấp nhận</a>";
                    }
                    echo "</td></tr>";
                }
                ?>
