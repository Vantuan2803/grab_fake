...
?>
    ...
    <div class="center" id="comru">
        <h3 class="text-center gradient-text">Đã hoàn thành</h3>
        <table id="tbl4" class="container-fluid col-lg-10 mr-lg-2 table table-hover table-bordered table-striped">
            <thead>
                <th onclick="sortTable(0,tbl4)">Thời gian đặt &#9660;</th>
                <th>Điểm xuất phát</th>
                <th>Điểm đến</th>
                <th>Loại xe</th>
                <th onclick="sortTablen(4,tbl4)">Quãng đường &#9660;</th>
                <th onclick="sortTablen(5,tbl4)">Hành lý</th>
                <th onclick="sortTable(6,tbl4)">Tổng tiền &#9660;</th>
                <th>Trạng thái</th>
                <th>Hóa đơn</th>
            </thead>
            <tbody id="tbl4c">
                ...
                $adm = new user();
                $admc = new dbcon();
                $showm = $adm->comride($id, $role, $admc->conn);
